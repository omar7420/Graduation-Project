...
import 'package:weather/models/weather_alerts_model.dart';
import 'package:weather/models/weather_current_model.dart';
import 'package:weather/models/weather_daily_model.dart';
import 'package:weather/models/weather_hourly_model.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<Object> fetchWeather(lat, lon) async {
    final response = await http.get(Uri.parse(
        'https://api.openweathermap.org/data/3.0/onecall?lat=$lat&lon=$lon&exclude=minutely&appid=18decebbe830c46f2003c45757d88283&units=metric'));
                                      ...
                                      background: SafeArea(
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              '${_response!.tempInfo.temperature.toStringAsFixed(0)}\u00B0 | ${_response!.weatherInfo.description.toTitleCase()}',
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 30,
                                            ...
                                            Text(
                                              'H:${_response!.tempInfo.temperature.toStringAsFixed(0)}\u00B0  L:${_response!.tempInfo.temperature.toStringAsFixed(0)}\u00B0',
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.w600),
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Column(
                                                                                children: [
                                                                                  Text(getTime(cityWeatherHr[index].dt), style: const TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w600)),
                                                                                ],
                                                                              ),
                                                                              Stack(
                                                                                    ...
                                                                                    Container(
                                                                                      ...
                                                                                      child: Padding(
                                                                                        ...
                                                                                        child: Text(
                                                                                          ...
                                                                                          style: const TextStyle(color: Colors.lightBlue, fontSize: 12, fontWeight: FontWeight.w800),
                                                                                        ),
                                                                                      ),
                                                                                    )
                                                                                  },
                                                                  ...
                                                                  child: Padding(
                                                                      ...
                                                                      child: SleekCircularSlider(
                                                                        ...
                                                                        appearance: CircularSliderAppearance(
                                                                            ...
                                                                            spinnerMode: false,
                                                                            infoProperties: InfoProperties(
                                                                                mainLabelStyle: const TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w600),
                                                                                modifier: (percentage) {
                                                                                  final roundedValue = percentage.ceil().toInt().toString();
                                                                                  return '$roundedValue' '\u00B0';
                                                                                },
                                                                                bottomLabelText: "Feels Like",
                                                                                bottomLabelStyle: const TextStyle(letterSpacing: 0.1, fontSize: 14, height: 1.5, color: Colors.white70, fontWeight: FontWeight.w700)),
                                                                            animationEnabled: true,
                                                                            size: 140,
                                                                      ...
                                                                      child: SleekCircularSlider(
                                                                        ...
                                                                        appearance: CircularSliderAppearance(
                                                                            infoProperties: InfoProperties(
                                                                                ...
                                                                                bottomLabelText: "hPa",
                                                                                bottomLabelStyle: const TextStyle(fontSize: 14, height: 1.5, color: Colors.white70, fontWeight: FontWeight.w700)),
                                                                            animationEnabled: true,
                                                                            size: 140,
                                      ...
                                      background: SafeArea(
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              '${cityWeather[cityIndex].cityTemp.toStringAsFixed(0)}\u00B0 | ${cityWeather[cityIndex].cityTempDesc.toTitleCase()}',
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 30,
                                                  fontWeight: FontWeight.w600),
                                            ...
                                            Text(
                                              'H:${cityWeather[cityIndex].cityHtemp.toStringAsFixed(0)}\u00B0  L:${cityWeather[cityIndex].cityLtemp.toStringAsFixed(0)}\u00B0',
                                              style: const TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.w600),
